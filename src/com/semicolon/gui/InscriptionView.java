        ...
        if (!password.getText().equals(confirmPassword.getText())) {
           ...
           if (tmaxage.getText().equals("")) {
            ...
            u1.setReligion(Enumerations.Religion.ATHEISM);
             ...
             else { u1.setReligion(Enumerations.Religion.AGNOSTICISM);
                    }
            ...
            else  { u1.setReligionImportance(Enumerations.Importance.IMPORTANT);
                    }
            ...
            else  { u1.setMaritalStatus(Enumerations.MaritalStatus.DIVORCED);
                    }
